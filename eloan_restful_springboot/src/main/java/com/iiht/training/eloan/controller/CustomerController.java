...
public class CustomerController {
	...
	public UserDto register(@RequestBody UserDto userDto){
		//ResponseEntity<UserDto> newuserDto = this.customerService.register();
		UserDto userDtoCustomer = 	this.customerService.register(userDto);
	...
	public List<LoanOutputDto> getStatusAll(@PathVariable Long customerId){
		...
		List<LoanOutputDto> loanOutputDetails = this.customerService.getStatusAll(customerId);
		
		return loanOutputDetails;
	}
